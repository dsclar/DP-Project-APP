...
shinyServer(
    function(input, output) { 
        ...
        output$Documentation <- renderText("The score you obtained today with your report of being clinically diagnosed or not will be recorded in an encrypted database without any personal identifier. 
The goal of this application is to collect data with the ultimate purpose to refine how depression can be detected using an optimal number of questions that woul yield the optimal sensitivity and specificity.")
